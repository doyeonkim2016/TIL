...
#1
([^<]+)
matches all the text in between the HTML start and end tags. we place a special restriction on the text in that it cant have
the "<" symbol.The characters inside the parenthesis are saved into Group #2
